...
1. Cемантическое значение. (i.e. как числа, буквы, строки)
...
int foo (const Heavy &fst, const Heavier &snd) {
  // ... fst.x
  /* этот вариант не имеет никаких из выше перечисленных возможныъ проблем

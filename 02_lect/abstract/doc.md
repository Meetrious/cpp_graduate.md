...
>> **l-value** называют сущности, имеющие место в памяти (статической, автоматической или динамической). Удобно думать об этом в духе: объект был выделен => проименован => он является *l-value*. В языке *C*, *l-value*, или "*левосторонние выражения*", являются тем, что может стоять слева от знака "=". Переменные аннотированные `const` тоже являются *l-value*, пусть им и нельзя переприсвоить значение отличное от их исходного, но в памяти они лежат. 
>
> "Чем являются l-value в *C++*?" - на этот вопрос мы ответим в 5й лекции.
...
<img src="imgs/ptref.png"> <br/>

Поглядим на их ассемблер:

<img src="imgs/ptref_asm.png"> <br/>
...
<img src="imgs/intersections.png"> <br/>

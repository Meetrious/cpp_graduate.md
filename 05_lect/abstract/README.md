...
Помимо конструкторов по умолчанию, пользовательских и копирования, существуют ещё [**конструктор перемещения**](https://en.cppreference.com/w/cpp/language/move_constructor). И он принимает первым аргументом правую ссылку на объект класса.
...
- либо не требует нетривиальных деструктора, копирований, перемещений и делает что-то другое.
...
Отвлечёмся от ссылок и *RAII* и поговорим о том, как в *C/C++* можно организовать $n$-мерные массивы.
## Двумерные массивы